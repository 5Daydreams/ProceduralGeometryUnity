...
namespace _Code
{
    ...
    public class PredictionLine : MonoBehaviour
    {
        ...
        private void OnDrawGizmos()
        {
            ...
            UnityEngine.Gizmos.DrawLine(pos, _directionTransform.position);
            ...
            for (int i = 0; i < _pointCount; i++)
            {
                ...
                UnityEngine.Gizmos.color = _trajColor;
                UnityEngine.Gizmos.DrawLine(pos, nextPos);
                ...
                UnityEngine.Gizmos.color = _spiralColor;
                UnityEngine.Gizmos.DrawLine(point1, point2);
                UnityEngine.Gizmos.DrawLine(point2, point3);
            }
        }
    }
}